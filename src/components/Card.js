...
const Card = (props) => {
    return (
        <div className='w-full max-w-[450px] h-auto relative py-40 px-2 flex flex-col items-center justify-center md:py-44'>
            ...
            <div className='absolute w-[330px] max-w-[400px] aspect-[11/6] bg-cardFront bg-no-repeat bg-cover left-2 bottom-2 rounded-md flex flex-col items-center p-6 text-[#fff] md:w-[400px] transition-all duration-1000'>
                <Image
